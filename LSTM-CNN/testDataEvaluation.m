...
%% CREATE JSON FILE
resultsPath = fullfile('LSTM-CNN', 'Test-Data', 'User-Results');
...
filePath = fullfile('LSTM-CNN', 'Test-Data', fileName);
save(filePath);
...
function saveResults(userResults, user)
    ...
    savePath = fullfile('LSTM-CNN', 'Test-Data', 'User-Results', fileName);
...
function jsonFormat(fileName,jsonName)
    % Load the data file
    filePath = fullfile('LSTM-CNN', 'Test-Data', fileName);
    jsonPath = fullfile('LSTM-CNN', 'Test-Data', jsonName);
    data = load(filePath);
